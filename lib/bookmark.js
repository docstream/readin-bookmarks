...
BookmarkService = (function() {
  ...
  BookmarkService.prototype.createBookmark = function(data, params, cbHash) {
    var bookmarkData;
    bookmarkData = data;
  ...
  BookmarkService.prototype.findSingleBookmark = function(id, userId, cbHash) {
    var params;
    params = {
      endUser: userId,
      _id: id
  ...
  BookmarkService.prototype.trashBookmark = function(id, userId, cbHash) {
    var params;
    params = {
      _id: id,
      endUser: userId
    };
    return Bookmark.trashSingle(params, function(err, trashedBookmark) {
      if (err) {
        return cbHash.MODEL_ERR(err);
        ...
        return cbHash.DEFAULT({
          data: trashedBookmark.toObject()
        });
      }
    });
  };

  BookmarkService.prototype.deleteTrashedBookmark = function(id, userId, cbHash) {
    var query;
    query = {
      _id: id,
      endUser: userId,
  ...
  BookmarkService.prototype.deleteUserBookmarks = function(userId, domainName, cbHash) {
    var query;
    query = {
      endUser: userId,
  ...
  BookmarkService.prototype.searchBookmarks = function(query, params, cbHash) {
    params = {
      endUser: params.userId,
      domainName: params.domainName
    };
    return Bookmark.searchBookmarks(params, query, (function(_this) {
